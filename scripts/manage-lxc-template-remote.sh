#!/bin/bash
# manage-lxc-template-remote.sh - Manage LXC templates on remote Proxmox host
set -e
...
usage() {
    ...
    echo "  $0 untemplate 9000 8999                       - Convert template 9000 to container 8999"
    echo "  $0 template 8999 9000                         - Convert container 8999 to template 9000"
    exit 1
}
